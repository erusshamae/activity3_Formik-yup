...
export default function LoginForm({ navigation }) {
  ...
  const handleLogin = async (values) => {
    try {
      const url = "http://192.168.1.8/api/v1/login";
      ...
      {({
        ...
        return (
          <View style={{ flex: 1, alignItems: "center", paddingHorizontal: 20 }}>
            <Text variant="displayMedium" style={{ color: "#e021ba", fontWeight: "bold"}}>Login</Text>
            <TextInput
              mode="outlined"
              placeholder="Email"
              label="Email"
            ...
            <TouchableOpacity onPress={() => {
              ...
              <Text style={{ color: "#e021ba", marginTop: 20, fontWeight: "bold", textDecorationLine: 'underline' }}>
                Forgot Password
              </Text>
            </TouchableOpacity>
          </View>
